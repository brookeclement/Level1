...
public class SimonSaysRecipe extends KeyAdapter {
	...
	private void makeAlbum() {
		...
		JOptionPane.showMessageDialog(null,
				"Press the matching key when 'Simon Says' pops up... Otherwise, press a different key.");
	...
	public void keyPressed(KeyEvent e) {
		...
		if (keyCode == imageIndex && simonSays == 0) {
			points = points + 1;
			speak("Correct");
			JOptionPane.showMessageDialog(null, "Score: " + points + "/" + tries);
	...
	private void showImage() {
		...
		if (simonSays == 0) {
			speak("Simon says pick the matching key");
		} else if (simonSays == 1) {
			speak("Pick the matching key.");
		}
	}
