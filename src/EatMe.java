...
private void makeAlbum() {
	...
	images.put(new Integer(KeyEvent.VK_DOWN), "cake.jpg");
	images.put(new Integer(KeyEvent.VK_RIGHT), "cheese.jpg");
...
public void keyPressed(KeyEvent e) {
	...
	{
		JOptionPane.showMessageDialog(null, "Incorrect. Learn some manners!");
	}
